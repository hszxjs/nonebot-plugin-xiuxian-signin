...
domain = importlib.import_module(f"{PKG_NAME}.domain")
...
record = domain.UserRecord(
    ...
    special_abilities=["初阈", "星律-流影篇", "风掣疾行"],
    mystic_boss_daily_attempts=1,
    mystic_boss_daily_bonus=1,
)
record.equipped_artifacts = {
    "\u4e3b\u624b": reward("\u4ed9\u9636", "\u6781\u54c1", "\u7075\u5668", "星阙断岳剑"),
    "\u526f\u624b": reward("\u5730\u9636", "\u4e0a\u54c1", "\u7075\u5668", "\u7384\u94c1\u9547\u9b42\u76fe"),
    "\u62a4\u7532": reward("\u5929\u9636", "\u4e2d\u54c1", "\u7075\u5668", "\u4e91\u7eb9\u62a4\u5fc3\u7532"),
}
record.equipped_artifact = record.equipped_artifacts["\u4e3b\u624b"]
record.equipped_method = reward("\u5929\u9636", "\u6781\u54c1", "\u529f\u6cd5", "青衡长生经")
record.equipped_array = reward("\u5929\u9636", "\u4e0a\u54c1", "\u9635\u76d8", "星衡列宿阵盘")
record.equipped_talisman = reward("\u7384\u9636", "\u4e0a\u54c1", "\u7b26\u7b93", "\u91d1\u7532\u62a4\u8eab\u7b26")
record.equipped_puppet = reward("\u5730\u9636", "\u4e2d\u54c1", "\u5080\u5121", "\u9752\u7389\u673a\u5173\u4eba")
record.life_artifact = reward("\u4ed9\u9636", "\u6781\u54c1", "\u7075\u5668", "青竹流云剑")
record.equipped_immortal_seed = reward("\u4ed9\u9636", "\u4e0a\u54c1", "\u4ed9\u79cd", "青枝回春仙种")
record.array_proficiency = {"星衡列宿阵盘": 320}

out = ROOT / "build" / "previews" / "adventure_preview_latest.png"
